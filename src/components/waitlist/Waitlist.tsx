  ...
  return (
    <Dialog>
      <DialogTrigger className="w-full md:w-fit">
        <div className="w-full rounded-lg border border-black bg-white px-4 py-2 text-black hover:bg-gray-100 sm:w-auto">
          Join the Waitlist
        </div>
      </DialogTrigger>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    How familiar are you with blockchain tech?
                  </FormLabel>
                  <Select onValueChange={field.onChange} value={field.value}>
                    <FormControl>
                      <SelectTrigger>
            ...
            <Button
              type="submit"
              className="w-full bg-secondary text-primary hover:bg-slate-400"
            >
