...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem } from '@/components/ui/dropdownMenu';
...
export function RegisterForm({ onClose }: RegisterFormProps) {
    ...
    // user will contain the MongoDB user data
