...
function BouncyControls({ children }: any) {
  ...
  return (
    <motion.group rotation={[springX, springY, 0]}>{children}</motion.group>
  )
}
...
function Watch(props: any) {
  ...
  return (
    ...
    >
      <mesh
        geometry={(nodes.Object005_glass_0 as any).geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={(nodes.Object006_watch_0 as Mesh).geometry}
